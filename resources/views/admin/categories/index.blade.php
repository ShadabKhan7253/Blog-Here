...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-item-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.categories.create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
            class="fas fa-plus fa-sm text-white-50 mr-1"></i>Create Category</a>
    </div>
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" onclick="deleteModalHelper('{{ route('admin.categories.destroy',$category->id) }}')"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
